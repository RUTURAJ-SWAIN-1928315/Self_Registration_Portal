...
if(aadharData){
  ...
  const matchingAddress = addressMaster.find(address => 
    ...
    const newRegistrationRequestBody = {
      ...
      nationalityId:formData.selectedNationalityId ? formData.selectedNationalityId:null,
      instituteId: formData.selectedReferralInstituteId ? formData.selectedReferralInstituteId: null,
      referredById:formData.selectedReferredById ? formData.selectedReferredById : null,
      referredToDrId: formData.selectedReferredToId ? formData.selectedReferredToId : null,
      refHospitalPatientNo:formData.refHospitalPatientNo,
      referralTypeId:formData.selectedReferralTypeId ? formData.selectedReferralTypeId : null,
      userId:profileData.userId ? profileData.userId : null,
      aadhaarNumber:formattedAadharNumber,
      photo:patientImage === null || patientImage === '' ? '' :patientImage,
      addressList:[
        {
          active:true,
          ...
          relationId:formData.selectedRelationId ? formData.selectedRelationId : null ,
